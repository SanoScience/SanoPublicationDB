...
# docker build -t pubdb .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name pubdb pubdb
...
COPY bin/check_backup_health /rails/bin/backup_healthcheck
